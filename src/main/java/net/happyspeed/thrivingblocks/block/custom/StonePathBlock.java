...
public class StonePathBlock
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        if (!this.getDefaultState().canPlaceAt(ctx.getWorld(), ctx.getBlockPos())) {
            return Block.pushEntitiesUpBeforeBlockChange(this.getDefaultState(), Blocks.STONE.getDefaultState(), ctx.getWorld(), ctx.getBlockPos());
        }
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        this.setToStone(null, state, world, pos);
    }

    @Unique
    public static void setToStone(@Nullable Entity entity, BlockState state, World world, BlockPos pos) {
        BlockState blockState = FarmlandBlock.pushEntitiesUpBeforeBlockChange(state, Blocks.STONE.getDefaultState(), world, pos);
